...
public class TagBean {
    ...
    public void associateTagtoPublication(long tag_id, long post_id) throws MyEntityNotFoundException {
        ...
        if (tag == null) {
            throw new MyEntityNotFoundException("tag with id " + tag_id + "was not found.");
        }
